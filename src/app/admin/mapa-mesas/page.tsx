/**
 * EventFlow — Interactive Table Map (Drag & Drop)
 * Visual floor plan editor for the celebration hall.
...
const DEFAULT_TABLES: TablePos[] = [
  { id: 't1', name: 'Mesa Principal', x: 350, y: 250, width: 100, height: 60, rotation: 0, capacity: 10, shape: 'rect', color: '#C9A84C' },
  { id: 't2', name: 'Mesa 1', x: 100, y: 100, width: 60, height: 60, rotation: 0, capacity: 8, shape: 'round', color: '#4682B4' },
  { id: 't3', name: 'Mesa 2', x: 300, y: 80, width: 60, height: 60, rotation: 0, capacity: 8, shape: 'round', color: '#6B8E23' },
  { id: 't4', name: 'Mesa 3', x: 550, y: 100, width: 60, height: 60, rotation: 0, capacity: 8, shape: 'round', color: '#9370DB' },
  { id: 't5', name: 'Mesa 4', x: 150, y: 350, width: 60, height: 60, rotation: 0, capacity: 8, shape: 'round', color: '#CD5C5C' },
  { id: 't6', name: 'Mesa 5', x: 550, y: 350, width: 60, height: 60, rotation: 0, capacity: 8, shape: 'round', color: '#20B2AA' },
  { id: 't7', name: 'Mesa 6', x: 350, y: 450, width: 100, height: 40, rotation: 0, capacity: 12, shape: 'long', color: '#A88A3A' },
];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="text-sm font-medium px-4 py-2.5 rounded-xl border border-[#E5E7EB] text-[#6B7280] hover:bg-[#F5F5F8] transition-colors"
          >
            + Añadir mesa
          </button>
          <button
        ...
        <div className="w-full lg:w-72 space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2 pt-2">
                  <button
                    ...
                    className="flex-1 text-xs font-medium py-2 rounded-lg border border-[#E5E7EB] hover:bg-[#F5F5F8] transition-colors"
                  >
                    ↻ Rotar
                  </button>
                  <button
                    onClick={() => deleteTable(selected.id)}
                    className="flex-1 text-xs font-medium py-2 rounded-lg bg-[#FEF2F2] text-[#DC2626] hover:bg-[#FCE3E3] transition-colors"
                  >
                    Eliminar
                  </button>
                </div>
          ...
          <div className="bg-[#FAF8F5] rounded-2xl border border-[#E0D3A8] p-4">
            ...
            <ul className="text-xs text-[#6B7280] space-y-1">
              ...
              <li>• <strong>Esquina inferior-derecha</strong> para redimensionar</li>
