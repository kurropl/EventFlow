...
- Name: configurador-full.spec.js >> PASO 5 — Envío y Confirmación >> Flujo completo: Boda → Menú → Extras → Resumen → Envío
- Location: tests/configurador-full.spec.js:351:3
...
Call log:
  - waiting for locator('button').filter({ hasText: 'Boda' })
