...
- Name: configurador-full.spec.js >> Flujos completos — Combinaciones >> Corporativo + 100 adultos + sin niños + Menú 1 + Usar + 2h barra
- Location: tests/configurador-full.spec.js:487:3
...
Call log:
  - waiting for locator('button').filter({ hasText: 'Corporativo' })
